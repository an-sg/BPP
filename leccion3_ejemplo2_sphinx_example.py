...
import leccion3_ejemplo2_sensors as leccion3_ejemplo2_sensors
...
def main():
    ...
    # Sensors
    sensor = leccion3_ejemplo2_sensors.Sensor("MySensor")
    print(sensor)
    temp_in = leccion3_ejemplo2_sensors.TempSensor("Inside")
    print(temp_in)
    temp_out = leccion3_ejemplo2_sensors.TempSensor("Outside", "C")
    print(temp_out)
    temp_out.set_unit("K")
    print(temp_out)
